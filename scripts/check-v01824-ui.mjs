...
if (missingSource.length) {
  throw new Error(`Missing v0.18.24 frontend integration: ${missingSource.join(" | ")}`);
}
...
if (missingCss.length) {
  throw new Error(`Missing v0.18.24 UI rule: ${missingCss.join(" | ")}`);
}

console.log("v0.18.24 UI: refactored components and approved dashboard styles are present.");
