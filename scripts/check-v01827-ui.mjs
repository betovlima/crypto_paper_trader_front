...
const checks = [
  ...
  [adaptive.includes("DataRefreshCountdownRing"), "20-second refresh countdown component present"],
  [adaptive.includes("refreshSeconds"), "refresh interval is passed to the countdown"],
...
console.log("v0.18.27 UI checks passed.");
